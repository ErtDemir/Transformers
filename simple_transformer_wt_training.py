...
dataset_root_dir = 'C:\\Users\\WhirlErt\\Desktop\\Transformers\\DFDC'
...
class TransformerModel(nn.Module):
    def __init__(self):
        ...
        self.projection = nn.Linear(8 * 8, 128)  
        
        self.transformer_layer = nn.TransformerEncoderLayer(d_model=128, nhead=8, dim_feedforward=512, dropout=0.1)
...
for epoch in range(num_epochs):
    ...
    print(f"Epoch {epoch+1}/{num_epochs} - Train Loss: {running_loss:.4f} | Train Acc: {100 * correct_train / total_train:.2f}% | Val Acc: {val_acc:.2f}%")
