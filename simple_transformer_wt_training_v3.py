...
class TransformerModel(nn.Module):
    def __init__(self):
        ...
        self.xception = models.efficientnet_b0(pretrained=True)
        self.xception.classifier = nn.Identity()

        self.linear_proj = nn.Linear(1280, 128)  # Embedding'e uygun hale getirme
